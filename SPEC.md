...
| התשובה הנכונה נחשפה | `score_correct_is` (רבות: `score_correct_multi`) + קטעי התשובות; בלי קטע — `score_correct_number` + מספרה; «הרוב קובע»: `misc_majority`; סקר: `misc_poll_results`; הימור: כלום |
